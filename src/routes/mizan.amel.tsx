...
export const Route = createFileRoute("/mizan/amel")({
  head: () => ({
    meta: [
      { title: "Amel — Mizan" },
      { name: "description", content: "Eylemler, sertifikalar, somut hedefler." },
    ],
  }),
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 py-6 sm:px-6">
      ...
      <div className="grid gap-3">
        {hedefler.map((h) => (
          <div key={h.ad} className="rounded-xl border border-border bg-card p-4 transition-colors hover:border-[var(--amel)]/40">
            ...
            <Progress value={h.ilerleme} className="h-1.5 bg-muted [&>div]:bg-[var(--amel)]" />
